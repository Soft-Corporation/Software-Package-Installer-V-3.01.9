...
Public Class Visual
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ProgressBar1.Show()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_0788608207bf47b993d691c63323ac15.zip"), TextBox1.Text)
        Panel7.Hide()
        Panel1.Hide()
    End Sub
