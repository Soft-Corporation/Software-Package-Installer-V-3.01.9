...
Public Class Advanced_Systemcare
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        timer1.Start
        downlaod.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_62bedab645ce4186934cd94853c4fc30.zip"), TextBox1.Text)
